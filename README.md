...
> Developed as part of the **GroupDNA Minor Project**.
...
The project was implemented **without using high-level data analysis libraries such as Pandas or Matplotlib**, following the project guidelines.
